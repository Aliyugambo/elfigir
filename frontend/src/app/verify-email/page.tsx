        ...
        <div className="text-center">
          {state === 'loading' && (
            <>
              ...
              <h1 className="text-2xl font-bold text-charcoal mb-2">Verifying your email...</h1>
              <p className="text-charcoal-light">Please wait while we verify your email address.</p>
            </>
          )}

          {state === 'success' && (
            <>
               <div className="w-12 h-12 bg-mustard/20 rounded-full flex items-center justify-center mx-auto mb-4">
                 <svg className="w-6 h-6 text-maroon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                   <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                 </svg>
               </div>
              <h1 className="text-2xl font-bold text-charcoal mb-2">Email Verified!</h1>
          ...
          {state === 'error' && (
            <>
              ...
              <h1 className="text-2xl font-bold text-charcoal mb-2">Verification Failed</h1>
              <p className="text-charcoal-light mb-6">
          ...
          {state === 'invalid' && (
            <>
               <div className="w-12 h-12 bg-mustard/20 rounded-full flex items-center justify-center mx-auto mb-4">
                 <svg className="w-6 h-6 text-mustard-dark" fill="none" stroke="currentColor" viewBox="0 0 24 24">
